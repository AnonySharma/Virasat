...
- **Insights** — a factual dashboard derived entirely from what's on file: headline counts (people, generations, average lifespan, living / remembered), gender split, born-by-decade, name trends, where the family is from, eldest & youngest, a whole-family **Coming up** list (clickable rows; "+N more" opens the full year ahead in a modal), and a compact **family calendar** marking every birthday and memorial with a small type icon per day — tap a marked day to open its people.
