...
(function (global) {
  ...
  function mount(root) {
    ...
    // Editable title: shows the family name + " family tree". Clicking it
    // (or the pencil icon) opens an inline edit. Persisted on state.meta.
    ...
    const header = UI.el("div", { class: "view-head" }, [
      UI.el("div", { class: "view-head__title-wrap" }, [titleEl, subEl]),
