...
(function (global) {
  ...
  function showNodeMenu(person, pos, ev) {
    ...
    // already role-gated at node build (line ~1124); this closes the menu path.
    ...
    // Reset". Re-picking the SAME direction on the already-focused person acts
    // as Reset; picking the OTHER direction just switches the walk.
    ...
    items.push(
      ...
      // too. Toggles to Reset when it's the active mode on this person.
      menuItem(
      ...
      menuItem(
        focusedHere && lineageFocusMode === "bloodline"
          ? (I18n.t("tree.resetView") || "Reset view")
          : (I18n.t("tree.focusBloodline") || "Focus bloodline"),
