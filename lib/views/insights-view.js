...
(function (global) {
  ...
  // feature module didn't load (e.g. a minimal build). The event rows, "+N more"
  // modal, and the calendar itself live in Anniversaries so the inspector's
  // Family Highlights can render the same surfaces without duplicating markup.
