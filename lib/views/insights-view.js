...
(function (global) {
  ...
  function comingUpPanel() {
    ...
    const rows = evs.slice(0, COMING_UP_MAX).map((ev) => {
      const meta = Anniversaries.eventMeta(ev);
      return el("div", { class: "coming-up__row" }, [
        el("i", {
    ...
    if (evs.length > COMING_UP_MAX) {
      rows.push(el("div", { class: "coming-up__more" },
        I18n.t("insights.comingUpMore", { n: evs.length - COMING_UP_MAX })));
    }
