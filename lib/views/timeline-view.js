  ...
  function mount(rootEl) {
    ...
    const head = el("div", { class: "view-head" }, [
      el("div", { class: "view-head__title-wrap" }, [
        el("span", { class: "view-head__eyebrow" }, I18n.t("timeline.eyebrow")),
        el("h2", { class: "view-head__title" }, [
          titleAccentEl,
          document.createTextNode(" " + I18n.t("timeline.titleWord"))
        ]),
    ...
    chip = el("span", { class: "chip chip--muted", title: I18n.t("timeline.pxPerYearTitle") }, pxLabel());
