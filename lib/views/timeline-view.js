...
(function (global) {
  ...
  function mount(rootEl) {
    ...
    const wrap = el("div", { class: "timeline-wrap" }, [controls, scroll, minimap]);
  ...
  function renderMinimap(rows, range) {
    ...
    if (!rows.length || !overflowing) { minimap.hidden = true; return; }
  ...
  function syncMinimapWindow() {
    if (!minimap || minimap.hidden || !minimapWindow || !scroll) return;
    const ncw = nameColWidth();
