...
(function (global) {
  ...
  function formatDateLong(s) {
    ...
    // even in Hindi UI (this is the most-seen date surface in the app). Locale
    // derived the same way (hi-IN / en-GB), Date built with the local-time
    // constructor so day-precision dates never shift a day across a tz boundary.
