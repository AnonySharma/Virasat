...
(function (global) {
  ...
  function renderHighlights() {
    ...
    if (oldest) {
      ...
      card(I18n.t("highlights.oldest"), oldest, I18n.t("highlights.born", { year: y != null ? y : "—" }), "fa-solid fa-tree");
    }
    ...
    if (latest) {
      ...
      card(I18n.t("highlights.latest"), latest, when ? I18n.t("highlights.added", { when }) : "", "fa-solid fa-user-plus");
    }
    ...
    if (mostStories) {
      ...
      card(I18n.t("highlights.mostStories"), mostStories, I18n.t(n === 1 ? "highlights.storyOne" : "highlights.storyMany", { n }), "fa-solid fa-book-open");
    }
  ...
  function render() {
    ...
    contentEl.appendChild(UI.el("div", { class: "inspector-actions" }, [
      iconAction("openInTree", "fa-solid fa-diagram-project", I18n.t("inspector.actOpenInTree"), () => {
      ...
      iconAction("share", "fa-solid fa-share-nodes",     I18n.t("inspector.actSaveImage"), async () => {
