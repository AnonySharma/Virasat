  ...
  const dict = {
    en: {
      ...
      auth: {
        ...
        errInvalid: "That email or password doesn't match. Try again.",
      ...
      share: {
        title: "Share",
        subtitle: "Invite family by email. They'll see this tree after they sign in.",
        ...
        inviteError: "Couldn't send the invite. Try again.",
    ...
    hi: {
      ...
      auth: {
        ...
        errInvalid: "यह ईमेल या पासवर्ड मेल नहीं खाता। पुनः प्रयास करें।",
      ...
      share: {
        title: "साझा करें",
        subtitle: "ईमेल से परिवार को आमंत्रित करें। साइन इन करने के बाद उन्हें यह वृक्ष दिखेगा।",
        emailLabel: "ईमेल पता",
        emailPlaceholder: "name@example.com",
        roleLabel: "पहुँच",
        ...
        inviteError: "आमंत्रण नहीं भेजा जा सका। पुनः प्रयास करें।",
