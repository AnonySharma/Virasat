...
(function (global) {
  ...
  function show() {
    return new Promise((resolve) => {
      ...
      // — Landing panel: what Virasat is, shown BEFORE the sign-in form so a
      //   first-time visitor understands the product before being asked to log
      //   in. "Get started" / "Sign in" reveal the auth card. —
      function feature(icon, titleKey, bodyKey, titleFb, bodyFb) {
        return make("div", { class: "landing__feature" }, [
          ...
          make("div", { class: "landing__feature-text" }, [
            make("h3", { class: "landing__feature-title" }, t(titleKey, titleFb)),
            make("p", { class: "landing__feature-body" }, t(bodyKey, bodyFb))
          ])
        ]);
      }
      const startBtn = make("button", { class: "btn btn--primary btn--block", type: "button" }, [
      ...
      const landing = make("div", { class: "signin__card landing__card" }, [
        make("div", { class: "signin__brand" }, [
          make("img", { class: "signin__logo", src: "assets/icon.svg", alt: "", width: "56", height: "56" }),
          make("h1", { class: "signin__title" }, t("app.title", "Virasat")),
