  ...
  function show() {
    return new Promise((resolve) => {
      ...
      function link(x1, y1, x2, y2) {
        return svg("line", { class: "landing__tree-link", x1: x1, y1: y1, x2: x2, y2: y2 });
      }
      ...
      function treeNode(cx, cy, r, tone) {
        const bx = r * 0.46, by = cy + r * 0.64, bt = r * 0.52;
        const body = "M " + (cx - bx) + " " + by
          + " q 0 " + (-bt) + " " + bx + " " + (-bt)
          + " q " + bx + " 0 " + bx + " " + bt + " Z";
        return svg("g", { class: "landing__tree-node landing__tree-node--" + tone }, [
      ...
      function treeMock() {
        const s = svg("svg", {
          ...
          treeNode(110, 44, 20, "sky"),
          treeNode(190, 44, 20, "rose"),
          treeNode(66, 150, 18, "sage"),
          treeNode(150, 150, 18, "peach"),
          treeNode(234, 150, 18, "lavender")
        ]);
