...
(function () {
  ...
  function showUpdateBanner(worker) {
    ...
    reload.addEventListener("click", () => {
      ...
      // If the worker already moved on to `activated` (e.g. a second tab
      // consented first), controllerchange may never fire again — reload now.
