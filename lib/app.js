...
(function () {
  ...
  function refreshMaintenance() {
    ...
    row("birth", s.missingBirth, "fa-regular fa-calendar-xmark", I18n.t("rail.needsBirth"));
    row("photo", s.missingPhoto, "fa-regular fa-image", I18n.t("rail.needsPhoto"));
    row("description", s.missingDescription, "fa-regular fa-pen-to-square", I18n.t("rail.needsDescription"));
  }
