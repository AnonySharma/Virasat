...
(function (global) {
   ...
   */
  function openModal({ title, body, footer, onClose, beforeClose }) {
  ...
  function onboardChrome() {
    ...
    return el("div", { class: "onboard-chrome" }, [themeBtn, langWrap]);
  }
  ...
  global.UI = { el, clear, clamp, avatar, toast, openModal, confirm, emptyState, cancelBtn, saveBtn, field, onboardChrome, downloadFile, pastelFor };
})(window);
