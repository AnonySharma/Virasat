...
(function (global) {
  ...
  function readLiveTreeToggles() {
    ...
    return {
      ...
      stories: b("virasat.showStoryCount", true),
  ...
  function openExport() {
    ...
    const state = {
      ...
      includeStories: liveShow.stories,
    ...
    const imgChips = [
      ...
      makeFieldChip({
        label: I18n.t("exp.imgStories"), icon: "fa-solid fa-book-open",
        active: state.includeStories,
        onChange: (on) => { state.includeStories = on; }
      }),
      makeFieldChip({
    ...
    pngBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        const { blob, filename } = await ImageExport.exportTreePng({
          ...
          includeStories: state.includeStories,
