...
(function (global) {
  ...
  // ===== exportTreePng =====
  /** @param {{familyName?: string, density?: number, includePhotos?: boolean, includeDates?: boolean, includePets?: boolean, includeStories?: boolean, includeEras?: boolean, includeRelations?: boolean, focusId?: string|null}} [opts] */
  async function exportTreePng({ familyName, density = 2, includePhotos = true, includeDates = true, includePets = true, includeStories = true, includeEras = false, includeRelations = false, focusId = null } = {}) {
    ...
    if (!includeStories) {
      // Story-count badge is a pure overlay disc+number on the photo ring —
      // removing it leaves no gap, so this trims cleanly.
