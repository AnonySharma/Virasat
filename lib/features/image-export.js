...
(function (global) {
  ...
  // the inspector's "Save as image" affordance — the function keeps the name
  // "share" because it routes through the OS share sheet where available; the
  // button label says "Save" so it doesn't collide with tree Sharing (invites).
